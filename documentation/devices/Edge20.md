...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet4 | mpls2 | routed | - | 192.20.25.1/24 | default | - | False | - | - |
| Ethernet5 | internet2 | routed | - | 192.20.26.1/24 | default | - | False | - | - |
...
| -------------- | -------------- | ---------------------- |
| Ethernet5 | - | internet_path2-RR3-Ethernet3<br>internet_path2-RR4-Ethernet3 |
...
| Interface name | Public address | STUN server profile(s) |
| -------------- | -------------- | ---------------------- |
| Ethernet4 | - | mpls_path2-RR3-Ethernet2<br>mpls_path2-RR4-Ethernet2 |
