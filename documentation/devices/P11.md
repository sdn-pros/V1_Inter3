...
| ------------ | --------------------------------- | ------------------------- | ------------------- | ---------- |
| FLOW-TRACKER | 70000 | 300000 | 1 | Dps1<br>Ethernet2<br>Ethernet3<br>Ethernet4<br>Ethernet5<br>Ethernet6 |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.99.102.62/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | comcast | routed | - | 192.16.52.2/24 | default | - | False | - | - |
| Ethernet3 | mpls_r1 | routed | - | 192.15.52.2/24 | default | - | False | - | - |
| Ethernet4 | mpls_global | routed | - | 192.52.81.1/24 | default | - | False | - | - |
| Ethernet5 | mpls_global | routed | - | 192.52.82.1/24 | default | - | False | - | - |
| Ethernet6 | ATT | routed | - | 192.52.75.1/24 | default | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.99.101.62/32 |
...
| --- | ------------------- | ------------ |
| default | 10.99.101.62:101 | - |
| VRF_A | 10.99.101.62:102 | connected |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.99.101.62:199 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.99.101.62:199 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.99.101.62:199 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.99.101.62:199 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.99.101.62:199
```
...
| -------------- | -------------- | ---------------------- |
| Ethernet2 | - | internet_path-RR1-Ethernet3<br>internet_path-RR2-Ethernet3<br>internet_path-RR3-Ethernet3<br>internet_path-RR4-Ethernet3 |
...
| Interface name | Public address | STUN server profile(s) |
| -------------- | -------------- | ---------------------- |
| Ethernet3 | - | mpls_r1_path-RR1-Ethernet2<br>mpls_r1_path-RR2-Ethernet2 |
...
| ----------- | ----------- | ------------ | ------------- | ---------------------- | ---------------- |
| LB-DEFAULT-AVT-POLICY-CONTROL-PLANE | - | - | - | internet_path (1)<br>mpls_global_path (1)<br>mpls_r1_path (1) | False |
| LB-DEFAULT-AVT-POLICY-DEFAULT | - | - | - | internet_path (1) | False |
| LB-PROD-AVT-POLICY-APP_SSH_PROFILE | - | - | - | internet_path (1)<br>mpls_global_path (2)<br>mpls_r1_path (2) | False |
| LB-PROD-AVT-POLICY-APP_TELNET_PROFILE | - | - | - | internet_path (1)<br>mpls_global_path (2)<br>mpls_r1_path (2) | False |
| LB-PROD-AVT-POLICY-DEFAULT | - | 2 | - | internet_path (1)<br>mpls_global_path (1)<br>mpls_r1_path (1) | False |
