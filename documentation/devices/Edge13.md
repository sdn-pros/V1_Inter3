...
| ------------ | --------------------------------- | ------------------------- | ------------------- | ---------- |
| FLOW-TRACKER | 70000 | 300000 | 1 | Dps1<br>Ethernet2<br>Ethernet3<br>Ethernet1 |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.99.102.13/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| Ethernet2 | mpls_r1 | routed | - | 192.13.15.1/24 | default | - | False | - | - |
| Ethernet3 | comcast | routed | - | 192.13.16.1/24 | default | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.99.101.13/32 |
...
| --- | ------------------- | ------------ |
| default | 10.99.101.13:101 | - |
| VRF_A | 10.99.101.13:102 | connected |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.99.101.13:103 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.99.101.13:103 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.99.101.13:103 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.99.101.13:103 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.99.101.13:103
```
...
| Interface name | Public address | STUN server profile(s) |
| -------------- | -------------- | ---------------------- |
| Ethernet2 | - | mpls_r1_path-RR1-Ethernet2<br>mpls_r1_path-RR2-Ethernet2 |
...
| ----------- | ----------- | ------------ | ------------- | ---------------------- | ---------------- |
| LB-DEFAULT-AVT-POLICY-CONTROL-PLANE | - | - | - | internet_path (1)<br>mpls_r1_path (1) | False |
| LB-DEFAULT-AVT-POLICY-DEFAULT | - | - | - | internet_path (1) | False |
| LB-PROD-AVT-POLICY-APP_SSH_PROFILE | - | - | - | internet_path (1)<br>mpls_r1_path (2) | False |
| LB-PROD-AVT-POLICY-APP_TELNET_PROFILE | - | - | - | internet_path (1)<br>mpls_r1_path (2) | False |
| LB-PROD-AVT-POLICY-DEFAULT | - | 2 | - | internet_path (1)<br>mpls_r1_path (1) | False |
...
router path-selection
   ...
   path-group mpls_r1_path id 1002
      ...
      local interface Ethernet2
         stun server-profile mpls_r1_path-RR1-Ethernet2 mpls_r1_path-RR2-Ethernet2
      !
      peer dynamic
      !
      peer static router-ip 10.99.102.1
...
| mpls_r1_path-RR1-Ethernet2 | 192.15.71.2 | STUN-DTLS | 3478 |
| mpls_r1_path-RR2-Ethernet2 | 192.15.72.2 | STUN-DTLS | 3478 |
...
stun
   client
      ...
      server-profile internet_path-RR4-Ethernet3
         ...
         ssl profile STUN-DTLS
      server-profile mpls_r1_path-RR1-Ethernet2
         ip address 192.15.71.2
         ssl profile STUN-DTLS
      server-profile mpls_r1_path-RR2-Ethernet2
